...
CFLAGS += -DQRCODE_EXPORTS -D_USRDLL -DMINGW_HAS_SECURE_API -DUNICODE -D_UNICODE -DNO_STRICT -DCMAKE_INTDIR=\"Release\"   
...
SOURCES := main.cpp ../ncbind/ncbind.cpp QR_Encode.cpp ../tp_stub.cpp
OBJECTS := $(SOURCES:.c=.o)
